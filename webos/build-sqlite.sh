#!/usr/bin/env bash
# Build SQLite 3.45.2 for HP TouchPad (ARMv7)
set -e

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
SRC="$SCRIPT_DIR/deps/src/sqlite-autoconf-3450200"
TARBALL="$SCRIPT_DIR/deps/src/sqlite-autoconf-3450200.tar.gz"
BUILD="$SCRIPT_DIR/build/sqlite"
